 ...
 */
package com.example.leaksdetector.watcher;
...
public final class RefWatcher {
    ...
    public void ensureGone(KeyedWeakReference reference, long watchStartNanoTime) {
    ...
    //这个类用来获取gcroot
    public void getgc(KeyedWeakReference reference, long watchStartNanoTime) {
